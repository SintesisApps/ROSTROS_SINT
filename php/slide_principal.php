  ...
  $("#r_flecha2").click(function(){
   ...
   <div class = "full-width-slider">
			...
			<div class = "slider">
				...
				<div class = "item" id = "item1">
                <div id="cont_img" class="cont_img" onClick="mostrar_ocultar("slide_sec1","box_sumario1")"><img src="img/fotos/8.jpg" class="foto_evnt" /></div>
				...
				<div class = "item" id = "item1">
                	...
                	<div id="cont_img" class="cont_img" onClick="mostrar_ocultar("slide_sec1","box_sumario1")"><img src="img/fotos/10.jpg" /></div>
               ...
               <div class = "item" id = "item1">
                	...
                	<div id="cont_img" class="cont_img" onClick="mostrar_ocultar("slide_sec1","box_sumario1")"><img src="img/fotos/15.jpg" /></div>
               ...
               <div class = "item" id = "item1">
                	...
                	<div id="cont_img" class="cont_img" onClick="mostrar_ocultar("slide_sec1","box_sumario1")"><img src="img/fotos/14.jpg" /></div>
